...
require('session_manager').setup({
  ...
  autoload_mode = config.AutoloadMode.LastSession, -- Define what to do when Neovim is started without arguments. Possible values: Disabled, CurrentDir, LastSession, CurrentDirThenLast
...
On startup, the value of `autoload_mode` is used to determine what session to initially load

| AutoloadMode            | Description                                                                                                    |
| ----------------------- | -------------------------------------------------------------------------------------------------------------- |
| Disabled                | No session will be loaded.                                                                                     |
| CurrentDir              | If a session for the current directory exists, it will be loaded.                                               |
| LastSession (*default*) | The last session will be loaded.                                                                               |
| CurrentDirThenLast      | The session in the current directory will be loaded, if it exists. Otherwise, the last session will be loaded. |
